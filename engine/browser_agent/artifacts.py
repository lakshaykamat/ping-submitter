...
from engine.browser_agent.events import record_screenshot_artifact
from engine.browser_agent.results import browser_history_metadata
...
def copy_history_screenshots(history, attempt_context, artifact_dir):
    ...
    for index, screenshot_path in enumerate(unique_paths, start=1):
        ...
        record_screenshot_artifact(attempt_context, destination, index)
    return copied_paths
